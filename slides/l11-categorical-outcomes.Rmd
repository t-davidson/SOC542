...
# Categorical outcomes
- Modeling categorical outcomes using existing tools:
    - OLS regression
...
# Multinomial logistic regression
- \textbf{Multinomial logistic regression} models allow us to generalize logistic regression to categorical outcomes and is suitable for *unordered* categories.

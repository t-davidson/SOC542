...
Most Stata datasets contain informative variable labels that you can view using R functions. We'll learn how to view them and store them into an R object.
...
Create a Scatter Plot of `vcr2001` and `homeownership_rate` with line of best fit.
...
crime %>%
  ...
  ggtitle("Scatter Plot of Violent Crime Rate vs. % Homeownership") +
...
Debug the code below! What function do you use to get a summarized model result?

...
# Course updates
## Homework 1
- Homework 1 released today, due Sunday at 5pm
    - Statistics review
    - Simple OLS regression
- Use link in email to download via Github Classroom

# Expectation and variance of two random variables
- The expectation of the sum of two random variables is equal to the sum of the expectations

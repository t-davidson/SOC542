...
# Updates
- Grading Homework 2
- Project proposals due Friday (3/6) at 5pm
...
- If White Male is set as the reference category, we could write this as:
...
- We can do this using the `margins` and `marginaleffects` R packages.\footnote{\footnotesize See  \href{https://cran.r-project.org/web/packages/margins/vignettes/TechnicalDetails.pdf}{documentation} for the margins package for further details.}

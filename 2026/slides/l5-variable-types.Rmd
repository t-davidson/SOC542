...
- Due Sunday (3/1) at 5pm via Github Classroom
...
- References
- Due next Friday, 3/6 at 5pm (via email)
...
# Dummy variables
## Reference category\footnote{\scriptsize See Johfre and Freese (2021) for further discussion of reference categories.}
```{r, out.width="70%",out.height="70%", fig.align="center"}
include_graphics('../../img/johfre_freese.png')
```
...
# Polynomials
## Predictions
```{r inc-age-preds, echo = FALSE, mysize=TRUE, size='\\scriptsize', warning = FALSE}

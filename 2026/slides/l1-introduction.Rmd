...
- Explanation
    - "I don't understand why we take the square root of a variance to get a standard deviation."
- Summarization
    - [Upload paper PDF] "Summarize the main argument of this paper"
- Question-answering
    - [Upload paper PDF] "Does this paper use logistic regression?"
- Debugging code
    - [Paste R code and error message] "Explain why my code failing?"
- Enhancing code
    - [Paste R code and data snippet] "Write an R function to create a standardized version of each of these variables."
    
# Artificial intelligence
## Strengths
- AI systems "know" a lot about statistics as they have "read" millions of texts, including academic research and documentation for technical software
- Many models are trained specifically to write code and can be helpful for debugging and assistance, and increasingly, for semi-autonomous "agentic" coding
- Latest models have capacity to analyze complex information sources including PDFs, spreadsheets, and audio files

# Artificial intelligence
## Weaknesses
- *Reliance on AI undermines learning*
- AI can "hallucinate", including inaccurate information or incorrect code
...
# Artificial intelligence
## Advice and rules
- The readings should be your primary data source
    - AI cannot read for you and summaries are only a supplement
- Experiment in R and try to debug manually
    - Read the error messages
    - Use "study mode" to enable AI to assist rather than solve
- Do not generate code or writing for your submissions
    - Use of tools like Grammarly is acceptable, but avoid heavy editing/rewriting with chatbots
- Document any AI usage in submissions
    - Include *valid* links to conversations
...
- Step 4: Authorize using a personal access token

...
modelsummary(list("OLS" = model_ols, "Bayes Flat" = bayes_uniform,
                  "Bayes Weak" = bayes_weak_prior, "Bayes Strong" = bayes_strong_prior),
             gof_omit = "IC|Log.Lik", add_rows = bayesrows)
...
small_bayes_unif <- stan_glm(kid_score ~ mom_iq, data = small_kidiq,
                             prior = NULL, prior_intercept = NULL,
                             refresh = 0) 
small_bayes_weak <- stan_glm(kid_score ~ mom_iq, data = small_kidiq,
                             prior = normal(location = 0, scale = 1), 
                             refresh = 0)
small_bayes_strong <- stan_glm(kid_score ~ mom_iq, data = small_kidiq,

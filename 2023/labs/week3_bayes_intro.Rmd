...
Above, we saw that there were only miniscule differences between the OLS the Bayesian models. Let's see what happens if we repeat the above exercizes with fewer observations. 

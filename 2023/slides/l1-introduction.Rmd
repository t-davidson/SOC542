...
- *Bayes Rules! An Introduction to Applied Bayesian Modeling* by Johnson, Alicia A., Miles Q. Ott, Mine Dogucu. 2021.
    - More detailed treatment of Bayesian inference with examples in R
...
# Statistics review
## Probability distributions in R
A *probability density function* provides a more general representation of the probability of observing particular random draws.
```{r, echo = FALSE}
...
-   A very active developer community
    - Lots of cool packages with regular updates

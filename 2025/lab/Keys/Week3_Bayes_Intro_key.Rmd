...
#### Quick Segue: Posterior predictive checks
...
From this plot, we can see that the regression lines are all nearly overlapping, suggesting that Bayesian estimates with weak priors closely resemble OLS estimates.

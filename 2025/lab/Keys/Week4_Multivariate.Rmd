...
var_table <- matrix(
  c(  
      ...
      "share_pop_hs",        "Negative", "A higher share of the poopulation with a high school diploma is associated with lower hate crime rates.",
      ...
      "share_vote_trump",    "Positive", "Regions with higher support for Trump are associated with higher hate crime rates."
    ), 
    ncol = 3, 
    byrow = TRUE
  )

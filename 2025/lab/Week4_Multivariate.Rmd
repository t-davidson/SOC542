...
# Combine the plots fbi_histogram and hate_crimes_map side by side
BLANK
...
Before diving into any regression analyses, let's think about each bivariate association between each possible independent variable and how it might relate to hate crime rates.
...
var_table <- matrix(
  c(  
    ...
    "share_unemp_seas", "BLANK", "BLANK.",
    "share_pop_metro", "BLANK", "BLANK.",
    "share_pop_hs", "BLANK", "BLANK.",
    "share_non_citizen", "BLANK", "BLANK.",
    "share_white_poverty", "BLANK", "BLANK.",
    "gini_index", "BLANK", "BLANK.",
    "share_non_white", "BLANK", "BLANK.",
    "share_vote_trump", "BLANK", "BLANK."
  ), 
  ncol = 3, 
  byrow = TRUE
)
...
# Education - share_pop_hs
BLANK

# Diversity - share_non_white; share_non_citizen
BLANK
model_div2 <- lm(hatecrimes_fbi ~ share_non_citizen, data = hate_crimes)

# Geographic Distribution  - share_pop_metro
BLANK


# Economic - median_house_inc; share_unemp_seas; share_white_poverty
BLANK
...
# Political Leanings - share_vote_trump
BLANK
...
# modelsummary(model_list) compiles results into a nice regression table too
BLANK
...
# Plotting the estimates of all_models_df with confidence intervals using ggplot()
BLANK

...
# Let's start by creating a vector of whole random numbers
a <- round(rnorm(n = 10, mean = 100, sd = 10))
...
```{r}
# Download wage1 dataset from Canvas into your working directory ('getwd' and 'setwd'). 
# Import wage1.dta using the read_dta() function from the haven package; name it wage_org
...
-   Select a subset of columns for further analysis (wage, educ_level, exper, tenure, gender, region) from the 'wage1' dataset and name the new data frame 'wage2'.
...
-   Calculate frequency tables with counts and percentages for the categorical variables 'educ_level', 'gender', and 'region'.

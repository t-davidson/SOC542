...
- But the choices encode assumptions about the social world and can be useful for theoretical reasons.\footnote{\scriptsize See Johfre and Freese (2021) for further discussion of reference categories.}
...
<!-- Removed some more advanced material. Interesting but may get a little confusing.
# Dummy variables
...
- The \textbf{natural logarithm} uses the constant $e \approx 2.718282$ as its base:
...
- The coefficients no longer have a simple interpretation.
    - Can change $Age$ while holding $Age^2$ constant?
